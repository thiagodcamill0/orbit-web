/**
 * _shared/crypto.ts — AES-256-GCM helpers compartilhados
 *
 * Usado por: functions/integrations e functions/chat-completion
 *
 ...
 * Lança erro se o formato for inválido ou a key incorreta.
 */
